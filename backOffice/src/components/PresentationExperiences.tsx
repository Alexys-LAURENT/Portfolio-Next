                    ...
                    <Card className="w-full" key={`experience-${experience.id}`}>
                        <CardBody className="flex-row justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                <svg onClick={() => showDrawer('Modifier une expérience', experience)} xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#0267da" className="bi bi-pen-fill hover:cursor-pointer" viewBox="0 0 16 16">
