                    ...
                    {competences.map((competence) => (
                        <Card key={`competence-${competence.id}`} className="w-32 h-32 flex-none">
                            ...
                            <CardFooter className="p-2 border-t-1 border-white/5 justify-around">
                                <svg onClick={() => showDrawer('Modifier une compétence', competence)} xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#0267da" className="bi bi-pen-fill hover:cursor-pointer hover:scale-125 transition-all" viewBox="0 0 16 16">
