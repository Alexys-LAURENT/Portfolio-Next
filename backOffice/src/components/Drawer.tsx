...
const DrawerItem = () => {
    ...
    const largeDisplay = ["Créer un projet", "Modifier un projet", "Créer une alternance", "Modifier une alternance"]
    return (
        <Drawer title={<h3 className='dark:text-white'>{drawerDisplay}</h3>} closeIcon={
            ...
            placement="right" onClose={closeDrawer} open={drawerOpen} className=' dark:bg-bgDark' size={largeDisplay.includes(drawerDisplay) ? "large" : "default"}>
