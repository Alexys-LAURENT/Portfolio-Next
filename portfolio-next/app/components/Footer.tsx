...
const Footer = () => {
    return (
        <footer className='flex w-full h-14 bg-bgLight dark:bg-bgDark justify-center gap-14'>
            <Link href='https://github.com/Alexys-LAURENT' target='_blank'>
            ...
            <Link href='https://www.linkedin.com/in/alexys-laurent-363210231/' target='_blank'>
