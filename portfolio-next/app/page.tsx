      ...
      <div className=" w-full">
        ...
        <div className="flex flex-col gap-16 items-center justify-center w-full h-[calc(100vh-60px)]">
          <div className="flex flex-col items-center gap-5">
            <h1 className="text-4xl lg:text-6xl font-extrabold">Alexys LAURENT</h1>
            <h2 className="text-4xl lg:text-6xl font-extrabold">{APropos && APropos.subTitle ? APropos.subTitle : ''}</h2>
          </div>
          <div>
            <button className="bg-btnColor px-4 py-2 rounded-md font-semibold hover:scale-105 transition-all">Qui suis-je ?</button>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col items-center gap-44 md:gap-96">
          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-0 items-center w-full max-w-[1000px] ">
            ...
            <div className="w-full md:w-8/12">
              <p className="font-semibold text-base lg:text-xl text-justify lg:pe-0">
            ...
            <div className="w-full md:w-4/12 flex justify-center md:justify-end">
              <button className="bg-btnColor text-sm lg:text-base px-4 py-2 rounded-md font-semibold hover:scale-105 transition-all">TÉLÉCHARGER MON CV</button>
            </div>
          ...
          <div className="flex flex-col gap-14 w-full items-center">
            <h3 className="text-3xl lg:text-4xl font-bold">Mes compétences</h3>
            <div className="flex flex-wrap gap-4 md:gap-8 lg:gap-14 justify-center">
              ...
              (
                <div key={`compétence-${item}`} className="flex flex-col items-center">
                  ...
                  <p className="text-center font-semibold text-xs md:text-base lg:text-lg">{item.nom}</p>
                </div>
              ))}
          ...
          {/* Experiences */}
          <div className="flex flex-col gap-14 w-full items-center">
            <h3 className="text-3xl lg:text-4xl font-bold">Mes expériences</h3>
